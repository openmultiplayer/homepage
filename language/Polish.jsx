...
export const FAQ = () => (
  <div>
    ...
    <hr />
    <h2>Jakie są wasze opinie na temat Kalcor'a/SA:MP/ogólnie?</h2>
    ...
    <p>To nie leży w naszej intencji. Najlepiej byłoby, gdyby w ogóle nie było żadnego podziału, ale rozdzielenie niektórych i uratowanie pewnej części jest lepsze niż oglądanie, jak cała społeczność upada. W rzeczywistości od czasu ogłoszenia tego projektu wiele osób spoza Anglii ponownie zaangażowało się w społeczność angielską. Grupy takich ludzi były powoli spychane na bok, tak więc ich ponowne włączenie łączy podzieloną społeczność. Duża liczba osób została zablokowana na oficjalnym forum SA:MP (a w niektórych przypadkach wszystkie ich wpisy zostały usunięte), ale sam Kalcor wskazał, że forum to nie cały SA:MP, a jedynie jego część. Wielu graczy i właścicieli serwerów nigdy nie umieściło wpisów na tym forum ani nie założyło nawet konta; zatem rozmowa z tymi ludźmi pozwoli zjednoczyć jeszcze większą część społeczności.</p>
    <hr />

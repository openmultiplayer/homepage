...
export const FAQ = () => (
  <div>
    ...
    <hr />
    <h2>Wat is jullie mening over Kalcor/SA:MP/wat dan ook?</h2>
    <p>Wij houden van SA:MP, dat is waarom wij in eerste instantie bestaan — wij hebben de creatie van open.mp te danken aan Kalcor. Hij heeft heel veel voor de modificatie gedaan, en die contributie moet niet vergeten of genegeerd worden. De acties die tot open.mp hebben geleid waren genomen omdat wij het oneens zijn met meerdere recente beslissingen en ondanks herhaalde pogingen om de modificatie in andere banen te lijden, was er geen oplossing tegemoetgekomen. Dus waren wij genoodzaakt om de ongelukkige keuze te maken en te proberen om door te gaan met SA:MP zonder Kalcor. Het is geen actie die tegen hem persoonlijk is genomen, en zal daarom niet moeten worden aangezien als persoonlijke aanval. Wij zullen geen enkele persoonlijke belediging tollereren, tegen niemand niet — desondanks wat hun mening over de open.mp kwestie is; we dienen om een gezond debat te kunnen houden zonder terug te vallen op tot persoon gerichte aanvallen.</p>
    <hr />
    <h2>Deze mod heet "Open" Multiplayer. Betekent dat dat de mod open source zal worden?</h2>
    <p>Op den duur is dat het plan, ja. Voor nu zijn we aan het proberen om de ontwikkeling open te houden qua communicatie en transparantie (wat op zichzelf al een verbetering is). We zullen stappen ondernemen om het project open source te maken zodra alles geregeld is en de rust is wedergekeerd.</p>
    <hr />

...
export const FAQ = () => (
  <div>
    ...
    <p>See ei ole meie eesmärk. Ideaalses maailmas poleks SA-MPist eraldumine üldse vajalik, kuid eraldumine ning olemasoleva päästmine on parem kui selle hääbumise kõrvalt vaatamine. Tegelikult on selle modifikatsiooni väljakuulutamise hetkest alates kogukonnaga taasliitunud paljud inglise keelt emakeelena mittekõnelevad inimesed, keda varasemalt eemale tõrjuti ning ignoreeriti, mistõttu võib öelda, et open.mp toob hoopis juba lõhestunud kogukonna taas kokku. SA-MP foorumist on bännitud palju inimesi ja teatud juhtudel on isegi kõik nende postitused kustutatud ning Kalcor ise on öelnud, et ametlik foorum ei ole SA-MP vaid kõigest osa sellest. Paljud mängijad, serveriomanikud ja arendajad ei ole sinna kordagi postitanud või isegi sellega liitunud, nende inimestega taas suhtluse alustamine ühendab juba eksisteerivat kogukonda veelgi enam.</p>
    <hr />

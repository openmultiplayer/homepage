...
export const BODY = FAQLink => (
  <div>
    ...
    <p>
      Una modifica di <em>Grand Theft Auto: San Andreas</em> in fase di sviluppo che sarà completamente retrocompatibile con la mod multiplayer già esistente <em>San Andreas Multiplayer.</em>
    </p>
    <br />
    <p>
      Questo significa che <strong>il client esistente di SA:MP e tutti gli script esistenti di SA:MP funzioneranno con open.mp</strong> e inoltre, molti errori verranno corretti nel software del server senza il bisogno di usare hack e raggiri.
    </p>
    <p>
...
export const FAQ = () => (
  <div>
    ...
    <hr />
    <h2>Cos'è open.mp?</h2>
    <p>open.mp (Open Multiplayer, OMP) è una mod multiplayer sostituta per San Andreas, iniziata come risposta allo sfortunato aumento dei problemi relativi agli aggiornamenti e alla gestione di SA:MP. Il primo rilascio sarà un completo rimpiazzo per il server. I client di SA:MP esistenti saranno in grado di collegarsi a questo server. In futuro, un nuovo client open.mp diventerà disponibile, il ché permetterà di rilasciare aggiornamenti più interessanti.</p>
    <hr />
    <h2>È un fork?</h2>
    <p>No. Questa è una riscrittura da zero, traendo vantaggio da decenni di conoscenza ed esperienza. Ci sono già stati tentativi di creare fork di SA:MP, ma crediamo che essi avessero due grossi problemi:</p>
    <ol>
      <li>Erano basati su codice divulgato di SA:MP. Gli autori di tali mod non avevano alcun diritto legale di utilizzare questo codice, ed erano dunque sulla difensiva, sia moralmente che legalmente. Noi ci rifiutiamo apertamente di utilizzare tale codice. Questo rallenta leggermente la velocità di sviluppo, ma è sicuramente la mossa giusta nel lungo termine.</li>
      <li>Hanno cercato di reinventare troppe cose alla volta. Sia rimpiazzando l'intero motore di scripting, che rimuovendo alcune funzionalità aggiungendone delle altre, o semplicemente ritoccando cose in maniera incompatibile. Questo impedisce ai server esistenti con enormi basi di codice e di giocatori di trasferirsi, poiché dovrebbero riscrivere parte, se non la totalità del loro codice - un'impresa potenzialmente massiccia. Certamente anche noi intendiamo aggiungere nuove funzionalità e ritoccare le cose col tempo, ma siamo anche focalizzati nel supportare i server esistenti, permettendogli di utilizzare il nostro codice senza che debbano cambiare il loro.</li>
    </ol>
    <hr />

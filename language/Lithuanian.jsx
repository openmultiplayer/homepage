...
export const BODY = (FAQLink) => (
  <div>
    ...
    <br />
    <p>
      Tai reiškia,<strong> kad SA:MP programa ir visi sukurti SA:MP skriptai veiks su open.mp</strong>, kartu bus sutaisyta daug klaidų serverio programinėje įrangoje apsieinant be įvairiausių apėjimų bei taip vadinamų hackų.
    </p>
    <p>
...
export const FAQ = () => (
  <div>
    ...
    <p>open.mp (Open Multiplayer, OMP) yra multiplayer režimo modas skirtas San Andreas, jis buvo pradėtas kaip atsakas į padidėjusį problemų skaičių administruojant bei naujinant SA:MP modą. Pirmoji modo versija bus jokių papildomų pastangų iš savininkų nereikalaujantis serverio atnaujinimas (nereikės nieko keisti kode). Visi esami SA:MP žaidėjai galės jungtis į šį serverį. Ateityje žaidėjams bus išleista nauja open.mp programa, kuri savininkams suteiks galimybę kurti įdomesnius atnaujinimus.</p>
    <hr />
    <h2>Ar tai SA:MP atšaka?</h2>
    <p>Ne. Tai yra nuo nulio kurtas modas, kuris išnaudos dešimtmečius kauptas žinias bei patirtį. Praeityje buvo bandymų atsišakoti nuo SA:MP, bet mes manome, kad tie bandymai turėjo dvi itin dideles problemas:</p>
    <ol>
      <li>Jų pagrindas buvo neteisėtai paplatintas SA:MP programinis kodas. Šių modų autoriai neturėjo jokių juridinių teisių šiam kodui, todėl buvo pasmerkti tiek etiškai, tiek teisiškai. Mes visiškai atsisakome naudoti šį paplatintą kodą. Dėl to nukentės mūsų progreso greitis, tačiau žiūrint į ateitį - tai teisingas sprendimas.</li>
      <li>Jie bandė visko per daug perdaryti. Ar tai pakeisti visą skriptų variklį, ar pašalinti vieną funkcionalumą, bet kartu pridėti naują, ar tiesiog koreguojant kodą taip, kad jis tampa nebesuderinamas. Tai užveria galimybes jau egzistuojantiems serveriams su dideliu kodo ir žaidėjų kiekiu migruoti pas juos, nes tam reiktų perrašyti dalį, o kartais net ir visą kodą. Visi suprantame, kad tai milžiniška užduotis. Mes pilnai pasiryžę eigoje pridėti naujo funkcionalumo, atlikti korekcijas, bet kartu mes itin sutelkę dėmesį į jau egzistuojančių serverių palaikymą, leidžiant jiems naudoti mūsų kodą nepakeitus savojo.</li>
    </ol>
    <hr />

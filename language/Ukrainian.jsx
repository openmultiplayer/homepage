...
export const BODY = (faq) => (
  <div>
    ...
    <p>
      Прийдешня мультиплеєрна модифікація до Grand Theft Auto: San Andreas, яка буде повністю зворотно сумісною з існуючою мультіплеєрною модифікацією, відомою як San Andreas Multiplayer.</em>
    </p>
    <br />
    <p>
      Це означає, що існуючий клієнт SA:MP і всі скрипти будуть працювати з open.mp, а також багато помилок в серверній частині мультиплеєра будуть виправлені без необхідності для хаков і тимчасових рішень.
    </p>
    <p>
...
export const FAQ = () => (
  <div>
    ...
    <p><a href="https://ru.wikipedia.org/wiki/OpenMP">Open Multiprocessing</a> - це "OpenMP", наш проект - "open.mp". Це дві абсолютно різні речі.</p>
  </div>
);

...
export const BODY = () => (
  <div>
    ...
    <p>
      Uma modificação em desenvolvimento para <em>Grand Theft Auto: San Andreas</em> que será totalmente compátivel com a modificação multiplayer existente <em>San Andreas Multiplayer.</em>
    </p>
    <br />
    <p>
...
export const FAQ = () => (
  <div>
    ...
    <hr />
    <h2>Por quê vocês estão fazendo isso?</h2>
    <p>Mesmo após numerosas tentativas de empurrar o desenvolvimento do SA:MP oficialmente, na forma de sugestões, vários pedidos, e ofertas de ajuda por parte do time de membros beta; uma comunidade literalmente implorando por qualquer atualização que seja; nenhum progresso foi visto. Isto foi percebido pela falta de interesse do fundador, o que não é um problema, mas não havia nenhuma linha de sucessão. Em vez de entregar o desenvolvimento nas mãos de alguém interessado em continuar a trabalhar na modificação, o fundador simplesmente escolheu trazer tudo abaixo consigo mesmo. Alguns clamam que isto foi por razões de ganancia passiva, mas não há evidências disso. Apesar do enorme interesse e de uma comunidade forte e familiar, ele acreditava que restavam apenas 1-2 anos na modificação e que a comunidade que havia trabalhado tanto para fazer o SA:MP o que é hoje, não merecia uma continuação.</p>
    <br />
    <p>Nós discordamos.</p>
    <hr />

...
export const BODY = (FAQLink) => (
  <div>
    ...
    <br />
    <p>
      Isto significa <strong>que clientes existentes do SA:MP e todos scripts SA:MP existentes irão funcionar com o open.mp</strong> e, adicionalmente, vários bugs com o sistema do servidor serão consertados sem a necessidade de trabalhos manuais por parte do usuário.
    </p>
    <p>
...
export const FAQ = () => (
  <div>
    ...
    <p>open.mp (Open Multiplayer, OMP) é um mod multiplayer substituto para San Andreas, iniciado em resposta ao infeliz aumento de problemas com atualizações e gerenciamento do SA:MP. O lançamento inicial vai ser uma substituição fácil para o software de servidor apenas. Clientes SA:MP serão capazes de conectar neste servidor. No futuro, um novo cliente open.mp vai ser disponibilizado, permitindo o lançamento de atualizações mais interessantes.</p>
    <hr />
    <h2>Isso é uma cópia/reaproveitamento de código?</h2>
    <p>Não. Este projeto foi totalmente reescrito, tendo a vantagem de décadas de conhecimento e experiências. Houveram tentativas de reaproveitar o código do SA:MP antes, mas acreditamos que tais tentativas tinham dois grandes problemas:</p>
    <ol>
      <li>Elas foram baseadas em um código fonte vazado do SA:MP. Os autores dessas modificações não tinham nenhum direito legal sobre este código, e assim sempre estiveram com uma desvantagem, tanto moral como legal. Nós nos recusamos a usar este código. Isto deixa o desenvolvimento um pouco mais lento, mas é a escolha certa a se fazer.</li>
      <li>Elas tentaram reinventar muito de uma vez. Ou por substituindo todo o motor de desenvolvimento, ou removendo e adicionando características, ou apenas por melhorar coisas de maneira incompativel. Isto impede que servidores com imensas bases de código e base de jogadores pudessem se mudar, já que teriam que reescrever alguns, se não todos, os seus códigos - um trabalho muito exaustivo. Nós temos a intenção de adicionar características, e melhorar as coisas com o passar do tempo, mas estamos também focados em dar suporte a servidores existentes, permitindo que eles usem nosso código sem alterar o deles.</li>
    </ol>
    <hr />
    <h2>Por que vocês estão fazendo isso?</h2>
    <p>Mesmo após numerosas tentativas de empurrar o desenvolvimento do SA:MP oficialmente, na forma de sugestões, vários pedidos, e ofertas de ajuda por parte da equipe de testadores de versões beta; uma comunidade literalmente implorando por qualquer atualização que seja; nenhum progresso foi visto. Isto foi percebido pela falta de interesse do fundador, o que não é um problema, mas não havia nenhuma linha de sucessão. Em vez de entregar o desenvolvimento nas mãos de alguém interessado em continuar a trabalhar na modificação, o fundador simplesmente escolheu trazer tudo abaixo consigo mesmo. Alguns clamam que isto foi por razões de ganância passiva, mas não há evidências disso. Apesar do enorme interesse e de uma comunidade forte e familiar, ele acreditava que restavam apenas 1-2 anos na modificação e que a comunidade que havia trabalhado tanto para fazer o SA:MP o que é hoje, não merecia uma continuação.</p>
    <br />
    <p>Nós discordamos.</p>
    <hr />
    <h2>Quais suas opiniões sobre o Kalcor ou SA:MP?</h2>
    <p>Nós amamos o SA:MP, e é por isso que estamos aqui em primeiro lugar - e nós devemos isso ao Kalcor. Ele fez muito pelo mod ao longo dos anos, e essa contribuição não deve ser esquecida ou ignorada. As ações que levaram ao open.mp foram tomadas porque discordamos de várias decisões recentes, e apesar das tentativas de guiar o mod em uma direção diferente, nenhuma solução foi vista como próxima. Assim, fomos forçados a tomar a infeliz decisão de tentar continuar o SA:MP em espírito sem o Kalcor. Esta não é uma ação tomada contra ele pessoalmente, e não deve ser vista como um ataque contra o mesmo. Não vamos tolerar insultos contra ninguém - independentemente de onde eles estejam em questão do open.mp; deveríamos ser capazes de ter um debate razoável sem recorrer a ataques à pessoa.</p>
    <hr />
    ...
    <p>Esta é uma a questão antiga e, infelizmente, temos a seguinte resposta para ela: quando estiver pronto. Simplesmente não há como saber quanto tempo um projeto como esse levará. Ele já está funcionando silenciosamente há algum tempo e já viu algumas mudanças no nível de atividade, dependendo de como as pessoas estão ocupadas. Mas é certeza que tudo está indo bem, e progredindo rapidamente graças a algumas decisões fundamentais de design (em breve falaremos sobre a arquitetura).</p>
    <hr />
